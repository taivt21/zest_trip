...
class _EditProfileScreenState extends State<EditProfileScreen> {
                            ...
                            Column(
                              children: [
                                ...
                                _buildTextFieldGender(
                                  label: "Gender",
                                  icon: genderIcons[_selectedGender] ??
                                      Icons.person,
  ...
  void _saveProfile() async {
    ...
    print(
        "Saving profile: Name=$_name, Phone=$_phone, DateOfBirth=$_selectedDate, Gender=${_selectedGender[0]}");
  }
}
